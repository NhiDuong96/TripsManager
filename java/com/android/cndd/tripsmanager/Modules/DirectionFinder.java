...
public class DirectionFinder {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyBehRrJCJXU07UgGl_kxvdi63xmK9kaWxU";
    ...
    private String createUrl() throws UnsupportedEncodingException {
        ...
        String url = DIRECTION_URL_API + "origin=" + urlOrigin + "&destination=" +
                urlDestination + "&key=" + GOOGLE_API_KEY + "&sensor=true";
        Log.e("URL", url);
        return url;
    }
